...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">Tạo mới Offer</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => ['offers.store'], 'method' => 'post', 'role' => 'form', 'class' => 'form-horizontal']) !!}
                        @include('layouts.partials.errors')

                        <div class="form-group">
                            <label class="col-md-3 control-label">Name</label>
                            <div class="col-md-9">
                                {!! Form::text('name', null, ['id' => 'name', 'class' => 'form-control', 'placeholder' => 'Tên Offer']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::select('network_id', ['' => '----- Chọn Network -----'] + \App\Site::networkList(), null, ['id' => 'network_id', 'class' => 'select2', 'data-placeholder' => 'Chọn Network...']) !!}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('redirect_link', null, ['id' => 'redirect_link', 'class' => 'form-control', 'placeholder' => 'Redirect link']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('click_rate', null, ['id' => 'click_rate', 'class' => 'form-control', 'placeholder' => 'Click Rate']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('geo_locations', null, ['id' => 'geo_locations', 'class' => 'form-control', 'placeholder' => 'Geo Locations']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::select('allow_devices', ['' => '----- Chọn Devices -----'] + config('devices'), null, ['id' => 'allow_devices', 'class' => 'select2', 'data-placeholder' => 'Chọn Devices...']) !!}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('net_offer_id', null, ['id' => 'net_offer_id', 'class' => 'form-control', 'placeholder' => 'Net Offer Id']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::checkbox('allow_multi_lead', '1', 1, ['data-plugin' => 'switchery', 'data-color' => '#81c868']) !!}
                                <span class="lbl"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::checkbox('check_click_in_network', '1', 1, ['data-plugin' => 'switchery', 'data-color' => '#81c868']) !!}
                                <span class="lbl"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::number('number_when_click', 0, ['id' => 'number_when_click', 'class' => 'form-control', 'placeholder' => 'number of virtual click when have click']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::number('number_when_lead', 0, ['id' => 'number_when_lead', 'class' => 'form-control', 'placeholder' => 'number of virtual click when have lead']) !!}
                            </div>
                        </div>
